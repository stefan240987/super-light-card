...
// --- 1. EDITOR KLASSEN (Den visuelle menu) ---
  ...
  render() {
    ...
    return html`
      <div class="card-config">
        ...
        <paper-input
          label="Ikon (f.eks. mdi:teddy-bear)"
...
class SuperLightCard extends LitElement {
  ...
  setConfig(config) {
    if (!config.main_entity) {
      throw new Error("Vælg venligst en 'Main Entity' i editoren.");
    }
    this.config = config;
  }
...
// Gør kortet synligt i "Add Card" menuen
